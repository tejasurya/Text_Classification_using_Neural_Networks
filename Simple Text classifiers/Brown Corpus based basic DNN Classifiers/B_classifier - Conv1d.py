...
model.add(Conv1D(192,kernel_size,padding='valid',activation='relu',strides=1, input_shape=(sequence_length,300)))
model.add(MaxPooling1D(pool_size=pool_size))
model.add(Conv1D(128,kernel_size,padding='valid',activation='relu',strides=1, input_shape=(sequence_length,300)))
...
model.add(MaxPooling1D(pool_size=pool_size))
model.add(Conv1D(256,kernel_size,padding='valid',activation='relu',strides=1, input_shape=(sequence_length,300)))
model.add(Conv1D(512,kernel_size,padding='valid',activation='relu',strides=1))
model.add(Conv1D(256,kernel_size,padding='valid',activation='relu',strides=1, input_shape=(sequence_length,300)))
model.add(Conv1D(512,kernel_size,padding='valid',activation='relu',strides=1))
model.add(Conv1D(256,kernel_size,padding='valid',activation='relu',strides=1, input_shape=(sequence_length,300)))
...
model.add(MaxPooling1D(pool_size=pool_size))
model.add(Conv1D(512,kernel_size,padding='valid',activation='relu',strides=1))
model.add(Conv1D(1024,kernel_size,padding='valid',activation='relu',strides=1))
model.add(MaxPooling1D(pool_size=pool_size))
model.add(Conv1D(512,kernel_size,padding='valid',activation='relu',strides=1, input_shape=(sequence_length,300)))
model.add(Conv1D(1024,kernel_size,padding='valid',activation='relu',strides=1))
model.add(Conv1D(512,kernel_size,padding='valid',activation='relu',strides=1, input_shape=(sequence_length,300)))
model.add(Conv1D(1024,kernel_size,padding='valid',activation='relu',strides=1))
model.add(Conv1D(1024,kernel_size,padding='valid',activation='relu',strides=1))
...
model.fit(padded_docs,y_train, nb_epoch=5, batch_size=64, validation_data=(vpadded_docs, y_valid), callbacks=[metriczs, plot])
