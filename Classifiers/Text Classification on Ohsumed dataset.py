...
os.chdir("G:/NLP/Dataset/ohsumed-allcats-6");
...
log = open("Ohsumed-Accuracy.txt", "w+")
...
#architect=['parallel_cross_leakyrelu', 'parallel_cross_elu', 'parallel_cross_relu', 'parallel_cross_newactivation', 'parallel_cross_straight_leakyrelu','parallel_cross_straight_elu', 'parallel_cross_straight_relu', 'parallel_cross_straight_newactivation']

i=0

sequence_leakyrelu()
text='Ohsumed_'+architect[i]+'_.png'
i=i+1
plt.savefig(text)
